...
# dedent function strips leading white-space from
# the beginnings of lines in a string written using """
# otherwise the strings would fail
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            member and your last mission is to get the neutron bomb
            from the Weapons Armory, put it in the bridge, blow the ship up
            after getting into an escape pod.

            You're running down the Central Corridor to the Weapons Armory
            when a Gothom jumps out, red scaly skin, dark grimy teeth,
            and evil clown custume flowing around his filled body. 
        ...
        if action == "shoot!":
            print(dedent("""
                ...
                Your laser hits his custume but misses him entirely.
                This completely ruins his brand new custume his mother
                bought him, which makes him fly into an insane rage and
                blast you repeatedly in the face until you are dead.
                Then he eats you.
                """))
            return 'death'
            ...
            print(dedent("""
                ...
                In the middle of your artful your foot slips and you bang
                your head on the metal wall and pass out. You wake up
            ...
            print(dedent("""
                ...
                Libhe zbgure vf fb sng, jura fur fvgf nebhaq fur fvgf nebhaq gur
                ubhfr. The Gothon stops, tries not to laugh, then busts out
                laughing you run up and shoot him the head putting him down,
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            You do a dive roll into the Weapon Armory, crounch and
            ...
            container.
            There's keypad lock on the box and you need the code
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            of the ship. Each of them has an even uglier clown custume than
        ...
        if action == "throw the bomb":
            ...
            print(dedent("""
                ...
                backward to the door, open it, and carefully palce the bomb
                on the floor, pointing your blaster at it. You jump back
                through the door, punch the close button and blast the lock
                so Gothons can't get out. Now that the bomb is placed you run
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print(dedent("""
                ...
                below. As it flies to the planet, you look back and see your ship
